...
emcc -O3 webp.c -I <libwebp> build/libwebp.a build/libsharpyuv.a \
  -sENVIRONMENT=node,web,worker -sMODULARIZE=1 -sEXPORT_ES6=1 -sALLOW_MEMORY_GROWTH \
  -sEXPORTED_FUNCTIONS='["_webp_encode_rgba","_webp_encode_lossless_rgba","_webp_encode_lossless_rgba_level","_webp_decode_rgba","_webp_free","_malloc","_free"]' \
